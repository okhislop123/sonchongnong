                    ...
                    <ul class="list-group">
                        ...
                        ?>
                            <li class="list-group-item <?php if ($_GET['p'] == 'size') echo "active" ?>">
                                <a href="?p=size&a=man"><i class="glyphicon glyphicon-chevron-right"></i> <span>Size</span></a>
                            </li>
                        <?php } ?> -->
                        ...
                        ?>
                            ...
                            <li class="list-group-item <?php if ($_GET['p'] == 'people') echo "active" ?>">
                                <a href="?p=people&a=man"><i class="glyphicon glyphicon-chevron-right"></i> <span>Số lượng người</span></a>
                            </li>
